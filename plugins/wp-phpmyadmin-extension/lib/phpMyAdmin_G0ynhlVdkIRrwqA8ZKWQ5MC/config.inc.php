...
$cfg['blowfish_secret']					= '{]\"#n\'Ec[Pl?:Rlz[#S*z|fWtM}ni(mD' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_G0ynhlVdkIRrwqA8ZKWQ5MC/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
